...
CString CScintillaDemoApp::GetModuleFileName(_Inout_opt_ DWORD* pdwLastError)
{
...
HMODULE CScintillaDemoApp::LoadLibraryFromApplicationDirectory(_In_z_ LPCTSTR lpFileName)
{
...
public:
  ...
  ~CAboutDlg() = default; //NOLINT(modernize-use-override)

  CAboutDlg& operator=(const CAboutDlg&) = delete;
  CAboutDlg& operator=(CAboutDlg&&) = delete;
