...
#include "UFMCore\ElementContainer.h"
#include "SharedViews\Views\SplashWnd.h"
#include "SharedViews\Dialogs\CDialogDatabaseSettings.h"
...
CMainFrame::CMainFrame()
{
	...
	((CModeler1App*)AfxGetApp())->m_nAppLook = ((CModeler1App*)AfxGetApp())->GetInt(_T("ApplicationLook"), ID_VIEW_APPLOOK_WINDOWS_7);
	m_pModelerView = NULL;
	CreateLists();
}
...
int CMainFrame::OnCreate(LPCREATESTRUCT lpCreateStruct)
{
	...
	OnApplicationLook(((CModeler1App*)AfxGetApp())->m_nAppLook);
	...
	CMFCToolBar::AddToolBarForImageCollection(IDR_MENU_IMAGES, ((CModeler1App*)AfxGetApp())->m_bHiColorIcons ? IDB_MENUIMAGES24 : 0);
...
void CMainFrame::InitMainButton()
{
	...
	pMainPanel->Add(new CMFCRibbonButton(ID_FILE_LOAD_DATABASE, _T("Load &From Database"), 1, 1));
	...
	// Disable for now beacuse it's too slow
...
BOOL CMainFrame::CreateDockingWindows()
{
	...
	SetDockingWindowIcons(((CModeler1App*)AfxGetApp())->m_bHiColorIcons);
	return TRUE;
}
...
void CMainFrame::OnApplicationLook(UINT id)
{
	...
	((CModeler1App*)AfxGetApp())->m_nAppLook = id;

	switch (((CModeler1App*)AfxGetApp())->m_nAppLook)
	{
	...
	((CModeler1App*)AfxGetApp())->WriteInt(_T("ApplicationLook"), ((CModeler1App*)AfxGetApp())->m_nAppLook);
}

void CMainFrame::OnUpdateApplicationLook(CCmdUI* pCmdUI)
{
	pCmdUI->SetRadio(((CModeler1App*)AfxGetApp())->m_nAppLook == pCmdUI->m_nID);
}
