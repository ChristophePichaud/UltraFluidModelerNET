...
{
#ifndef SHARED_HANDLERS
	((CModeler1App*)AfxGetApp())->GetContextMenuManager()->ShowPopupMenu(IDR_POPUP_EDIT, point.x, point.y, this, TRUE);
#endif
}
...
void CModeler1View::OnFileImportPUML()
{
	GetManager()->OnFileImportPUML(this);
}
...
void CModeler1View::OnOperationDelete()
{
	GetManager()->OnOperationDelete(this);
}

void CModeler1View::OnUpdateOperationDelete(CCmdUI* pCmdUI)
{
	pCmdUI->Enable(GetManager()->HasSelection());
}
