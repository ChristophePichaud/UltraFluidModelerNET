...
#include "pch.h"
#include "UFMCore\AppInit.h"
#include "UFMCore\Modeler1.h"
#include "UFMCore\MainFrm.h"
#include "UFMCore\ChildFrm.h"
...
BOOL CModeler1App::InitInstance()
{
	...
	((CModeler1App*)AfxGetApp())->GetTooltipManager()->SetTooltipParams(AFX_TOOLTIP_TYPE_ALL,
