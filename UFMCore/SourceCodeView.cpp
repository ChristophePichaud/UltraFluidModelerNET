...
#include "UFMCore\SourceCodeView.h"
...
//void CSourceCodeView::OnChar(UINT nChar, UINT nRepCnt, UINT nFlags)
//{
...
//	{
//		CString text;
//		text = GetCtrl().GetText(10240);
//		m_pElement->m_code = T2W((LPTSTR)(LPCTSTR)text);
//	}
//}


//BOOL CSourceCodeView::OnNotify(WPARAM wParam, LPARAM lParam, LRESULT* pResult)
//{
//	// TODO: Add your specialized code here and/or call the base class
//	return CScintillaView::OnNotify(wParam, lParam, pResult);
//}

void CSourceCodeView::OnModified(_Inout_ SCNotification* /*pSCNotification*/)
{
